...
/**
 * Calibrated average-adult defaults (anthropometric middle point), sourced from
 * "Project AIBO/Appropriate measurement.txt". A scan/capture for an average
 * adult should land close to these; "reset to default" restores them exactly.
 */
export const DEFAULT_RIG: RigConfig = {
  neckCm: 20.592082668583554,
  torsoCm: 56.534971280143836,
  upperArmCm: 26.438527365534682,
  lowerArmCm: 26.85274966102798,
  upperLegCm: 44.95571246295987,
  lowerLegCm: 41.072616433535316,
  footCm: 16.801889918782315,
  shoulderWidthCm: 37.437426651059994,
  hipWidthCm: 25.06882358498164,
  headDiameterCm: 16.45859888108773,
  hipHeightCm: 83.09598350455524,
  neckRcm: 4.3,
  torsoRcm: 15.1,
  upperArmRcm: 6,
  lowerArmRcm: 4.6,
  ...
  fingerRcm: 0.9,
  palmRcm: 2.2,
  handLengthCm: 20.139562245770982,
  fingerThumb: 1.1,
  fingerIndex: 1.1,
  fingerMiddle: 1.1,
  fingerRing: 1.1,
